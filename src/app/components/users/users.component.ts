...
export class UsersComponent {
  ...
  search(){
    this.filteredUsers = this.users.filter(user=>user.username.includes(this.searchValue))
  }
  
  // search() {
  //   console.log('Search Value:', this.searchValue); // Check the search value
  //   this.filteredUsers = this.users.filter(user => {
  //     const result = user.username.includes(this.searchValue);
  //     console.log('User:', user.username, 'Include:', result); // Check each filter result
  //     return result;
  //   });
  //   console.log('Filtered Users:', this.filteredUsers); // Check the filtered users
  // }
